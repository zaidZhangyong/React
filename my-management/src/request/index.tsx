...
=======
  (config) => {
    //配置自定义请求头
    config.headers.set("language", "zh-cn");
...
const requestHandler = (method: 'get' | 'post' | 'put' | 'delete', url: string, params: object = {}, config: AxiosRequestConfig = {}): Promise<axiosTypes> => {
